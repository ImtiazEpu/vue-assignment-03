<script setup>
const newsletterBgShape = 'src/assets/images/background-shape/seo-ball-2.png';
...
<template>
  ...
  <section class="newsletter">
    ...
    <!-- background shapes -->
    <img class="newsletter-bg-shape left-right-animation" :src="newsletterBgShape" alt="background-shape">
  </section>
  <!-- /newsletter -->
</template>
